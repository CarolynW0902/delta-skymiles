...
signupBtn.addEventListener('click', (e) => {
    ...
    if(firstName) {
      ...
      errors = getSignupFormErrors(firstName.value, lastName.value, signupEmail.value, signupPassword.value, reenterPassword.value)
    }else {
...
function getSignupFormErrors(firstname, lastname, email, password, reEnterPassword) {
  let errors = [];
...
const allInputs = [firstName, lastName, signupEmail, signupPassword, reenterPassword];
